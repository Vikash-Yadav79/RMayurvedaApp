...
const CheckoutScreen = ({navigation, route}) => {
  const {defaultAddress} = route.params || {}; // Get the default address from params
        ...
        <View style={styles.addressContainer}>
          {defaultAddress ? (
            <>
              ...
              <Text style={styles.addressName}>{defaultAddress.city}</Text>
              <Text style={styles.addressText}>{defaultAddress.state}</Text>
              <Text style={styles.addressName}>{defaultAddress.pincode}</Text>
